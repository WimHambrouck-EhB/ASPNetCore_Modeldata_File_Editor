    ...
    public class FilesController : Controller
    {
        ...
        public IActionResult Manager()
        {
            ...
            if (IsSessionUserPathExpired(out string userPath))
                return RedirectToAction(nameof(AccountsController.Login), AccountsController.SimpleName);
        ...
        public IActionResult Create(string filename)
        {
            ...
            else
            {
                ...
                string filePath = $"{userPath}\\{filename}.txt";
        ...
        /// <summary>
        /// User krijgt eerst GET /Delete/{filename} te zien met een bevestiging. Als daar een POST gebeurt, komen we hier terecht.
        /// ActionName doorbeekt de ASP.NET-conventie dat naam van de methode == naam van de actie en laat toe een andere naam voor de actie in te stellen. 
        /// Dit omdat we anders 2 methodes Delete hebben met dezelfde signatuur, waarmee de compiler niet blij zal zijn,
        /// maar we willen wel dat zowel de GET- als de POST-actie om een bestand te verwijderen allebei "Delete" heten.
        /// </summary>
        ...
        {
            sessionUserPath = HttpContext.Session.GetString(KEY_SESSION_USER_PATH) ?? string.Empty;
